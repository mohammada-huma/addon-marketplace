# PortalMarketplace This project was generated using [Angular
...
```bash ng build marketplace ``` This command will compile your
...
dist/marketplace ``` 2. Run the `npm publish` command to publish
